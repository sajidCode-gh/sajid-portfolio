...
`;function Tv(e,t,n){switch(n){case"bottom-left":return t?kv:ov;case"bottom-right":return t?_v:lv;case"down":return e?t?Ev:av:t?Cv:sv;case"left":return e?t?Pv:uv:t?$v:Uu;case"right":return e?t?Nv:fv:t?jv:cv;case"top-left":return t?zv:dv;case"top-right":return t?Mv:pv;case"up":return e?t?Ov:hv:t?Iv:mv;default:return t?Sv:iv}}var Ao=e=>{const{big:t=!1,direction:n,reverse:r=!1,...i}=e,o=z.useMemo(()=>Tv(t,r,n),[t,n,r]);return se(qp,{keyframes:o,...i})};$`
  from {
